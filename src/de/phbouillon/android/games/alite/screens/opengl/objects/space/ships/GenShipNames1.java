...
public class GenShipNames1 extends SpaceObject {
	private static final long serialVersionUID = -7433337226334348052L;
    ...
    private static final float [] TEXTURE_COORDINATE_DATA = new float [] {
          0.00f,   0.07f,   0.49f,   0.07f,   0.49f,   0.01f, 
          0.00f,   0.07f,   0.49f,   0.01f,   0.00f,   0.01f, 
          0.00f,   0.08f,   0.49f,   0.08f,   0.49f,   0.01f, 
          0.00f,   0.08f,   0.49f,   0.01f,   0.00f,   0.01f, 
          0.00f,   0.08f,   0.49f,   0.08f,   0.49f,   0.01f, 
          0.00f,   0.08f,   0.49f,   0.01f,   0.00f,   0.01f, 
          0.00f,   0.08f,   0.49f,   0.08f,   0.49f,   0.01f, 
          0.00f,   0.08f,   0.49f,   0.01f,   0.00f,   0.01f
    ...
    public GenShipNames1(Alite alite) {
