...
public class GenShipNames2 extends SpaceObject {
	private static final long serialVersionUID = 8531477530538236024L;
    ...
    private static final float [] TEXTURE_COORDINATE_DATA = new float [] {
          0.01f,   0.14f,   0.50f,   0.14f,   0.50f,   0.07f, 
          0.01f,   0.14f,   0.50f,   0.07f,   0.01f,   0.07f, 
          0.01f,   0.14f,   0.50f,   0.14f,   0.50f,   0.07f, 
          0.01f,   0.14f,   0.50f,   0.07f,   0.01f,   0.07f, 
          0.01f,   0.14f,   0.50f,   0.14f,   0.50f,   0.07f, 
          0.01f,   0.14f,   0.50f,   0.07f,   0.01f,   0.07f, 
          0.00f,   0.14f,   0.50f,   0.14f,   0.50f,   0.07f, 
          0.00f,   0.14f,   0.50f,   0.07f,   0.00f,   0.07f
    };

    public GenShipNames2(Alite alite) {
