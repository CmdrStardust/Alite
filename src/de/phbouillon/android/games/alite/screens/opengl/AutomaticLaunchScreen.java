...
public class AutomaticLaunchScreen extends GlScreen {
	private static final long serialVersionUID = -5030666956665281244L;
	...
	public AutomaticLaunchScreen(Game game) {
		super(game);
	}
...
//				newScreen = new FlightScreen(game, true);
	...
	public int getScreenCode() {
		return ScreenCodes.AUTOMATIC_LAUNCH_SCREEN;
	}
}
