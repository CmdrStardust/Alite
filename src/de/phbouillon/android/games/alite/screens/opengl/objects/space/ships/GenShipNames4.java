...
public class GenShipNames4 extends SpaceObject {
	private static final long serialVersionUID = -1429796582273212739L;
    ...
    private static final float [] TEXTURE_COORDINATE_DATA = new float [] {
          0.01f,   0.27f,   0.49f,   0.27f,   0.49f,   0.20f, 
          0.01f,   0.27f,   0.49f,   0.20f,   0.01f,   0.20f, 
          0.01f,   0.27f,   0.49f,   0.27f,   0.49f,   0.21f, 
          0.01f,   0.27f,   0.49f,   0.21f,   0.01f,   0.21f, 
          0.01f,   0.27f,   0.49f,   0.27f,   0.49f,   0.21f, 
          0.01f,   0.27f,   0.49f,   0.21f,   0.01f,   0.21f, 
          0.01f,   0.27f,   0.49f,   0.27f,   0.49f,   0.20f, 
          0.01f,   0.27f,   0.49f,   0.20f,   0.01f,   0.20f
    ...
    public GenShipNames4(Alite alite) {
