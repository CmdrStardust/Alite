...
public class DockingBay implements Serializable {
	private static final long serialVersionUID = 1080890954061329825L;
    ...
    private static final float [] BAY_VERTEX_DATA = new float [] {
        -10.24f, -30.72f,  160.00f, -10.24f, -30.72f,    0.00f, 
        -10.24f,  30.72f,    0.00f, -10.24f,  30.72f,  160.00f, 
         10.24f, -30.72f,  160.00f,  10.24f, -30.72f,    0.00f, 
         10.24f,  30.72f,    0.00f,  10.24f,  30.72f,  160.00f
    };
	...
	DockingBay(final Alite alite) {
		this.alite = alite;
		init();
	}
	
	private void init() {
		vertexBuffer = create(6.0f, BAY_VERTEX_DATA, BAY_NORMAL_DATA,
	...
	private void readObject(ObjectInputStream in) throws IOException {
		try {
			AliteLog.e("readObject", "DockingBay.readObject");
			in.defaultReadObject();
			AliteLog.e("readObject", "DockingBay.readObject I");
			this.alite = Alite.get();
			init();
			AliteLog.e("readObject", "DockingBay.readObject II");
