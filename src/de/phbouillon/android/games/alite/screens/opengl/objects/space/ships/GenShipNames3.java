...
public class GenShipNames3 extends SpaceObject {
	private static final long serialVersionUID = 8006237508992936207L;
    ...
    private static final float [] TEXTURE_COORDINATE_DATA = new float [] {
          0.01f,   0.21f,   0.50f,   0.21f,   0.50f,   0.14f, 
          0.01f,   0.21f,   0.50f,   0.14f,   0.01f,   0.14f, 
          0.01f,   0.21f,   0.50f,   0.21f,   0.50f,   0.14f, 
          0.01f,   0.21f,   0.50f,   0.14f,   0.01f,   0.14f, 
          0.01f,   0.21f,   0.50f,   0.21f,   0.50f,   0.14f, 
          0.01f,   0.21f,   0.50f,   0.14f,   0.01f,   0.14f, 
          0.00f,   0.21f,   0.50f,   0.21f,   0.50f,   0.14f, 
          0.00f,   0.21f,   0.50f,   0.14f,   0.00f,   0.14f
    };

    public GenShipNames3(Alite alite) {
