...
public class DodecDockingBay implements Serializable {
    ...
    private static final float [] BAY_VERTEX_DATA = new float [] {
        -16.00f, -48.00f,  196.00f, -16.00f, -48.00f,    0.00f, 
        -16.00f,  48.00f,    0.00f, -16.00f,  48.00f,  196.00f, 
         16.00f, -48.00f,  196.00f,  16.00f, -48.00f,    0.00f, 
         16.00f,  48.00f,    0.00f,  16.00f,  48.00f,  196.00f
    };
	...
	DodecDockingBay(final Alite alite) {
		this.alite = alite;
		init();
	}
	
	private void init() {
		vertexBuffer = create(4.897959f, BAY_VERTEX_DATA, BAY_NORMAL_DATA,
