...
public class HackerScreen extends AliteScreen {
	...
	private void initializeState(Alite alite) {
		...
		state.setFood(inventory[0].getWeightInGrams());
		state.setTextiles(inventory[1].getWeightInGrams());
		state.setRadioactives(inventory[2].getWeightInGrams());
		state.setSlaves(inventory[3].getWeightInGrams());
		state.setLiquorWines(inventory[4].getWeightInGrams());
		state.setLuxuries(inventory[5].getWeightInGrams());
		state.setNarcotics(inventory[6].getWeightInGrams());
		state.setComputers(inventory[7].getWeightInGrams());
		state.setMachinery(inventory[8].getWeightInGrams());
		state.setAlloys(inventory[9].getWeightInGrams());
		state.setFirearms(inventory[10].getWeightInGrams());
		state.setFurs(inventory[11].getWeightInGrams());
		state.setMinerals(inventory[12].getWeightInGrams());
		state.setGold(inventory[13].getWeightInGrams());
		state.setPlatinum(inventory[14].getWeightInGrams());
		state.setGemStones(inventory[15].getWeightInGrams());
		state.setAlienItems(inventory[16].getWeightInGrams());
		state.setMedicalSupplies(inventory[17].getWeightInGrams());		
	...
	private void assignState(Alite alite) {	
		...
		cobra.setTradeGood(TradeGoodStore.get().food(), Weight.grams(state.getFood()));
		cobra.setTradeGood(TradeGoodStore.get().textiles(), Weight.grams(state.getTextiles()));
		cobra.setTradeGood(TradeGoodStore.get().radioactives(), Weight.grams(state.getRadioactives()));
		cobra.setTradeGood(TradeGoodStore.get().slaves(), Weight.grams(state.getSlaves()));
		cobra.setTradeGood(TradeGoodStore.get().liquorWines(), Weight.grams(state.getLiquorWines()));
		cobra.setTradeGood(TradeGoodStore.get().luxuries(), Weight.grams(state.getLuxuries()));
		cobra.setTradeGood(TradeGoodStore.get().narcotics(), Weight.grams(state.getNarcotics()));
		cobra.setTradeGood(TradeGoodStore.get().computers(), Weight.grams(state.getComputers()));
		cobra.setTradeGood(TradeGoodStore.get().machinery(), Weight.grams(state.getMachinery()));
		cobra.setTradeGood(TradeGoodStore.get().alloys(), Weight.grams(state.getAlloys()));
		cobra.setTradeGood(TradeGoodStore.get().firearms(), Weight.grams(state.getFirearms()));
		cobra.setTradeGood(TradeGoodStore.get().furs(), Weight.grams(state.getFurs()));
		cobra.setTradeGood(TradeGoodStore.get().minerals(), Weight.grams(state.getMinerals()));
		cobra.setTradeGood(TradeGoodStore.get().gold(), Weight.grams(state.getGold()));
		cobra.setTradeGood(TradeGoodStore.get().platinum(), Weight.grams(state.getPlatinum()));
		cobra.setTradeGood(TradeGoodStore.get().gemStones(), Weight.grams(state.getGemStones()));
		cobra.setTradeGood(TradeGoodStore.get().alienItems(), Weight.grams(state.getAlienItems()));
		cobra.setTradeGood(TradeGoodStore.get().medicalSupplies(), Weight.grams(state.getMedicalSupplies()));
	}
