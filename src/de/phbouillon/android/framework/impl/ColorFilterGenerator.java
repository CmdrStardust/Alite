...
public class ColorFilterGenerator {
	...
	public static ColorFilter adjustColor(int contrast, int saturation, int hue) {
		cm.reset();
		adjustHue(cm, hue);
		adjustContrast(cm, contrast);
		adjustSaturation(cm, saturation);
	...
	public static ColorFilter adjustColor(int saturation, int hue) {
		cm.reset();
		adjustHue(cm, hue);
		adjustSaturation(cm, saturation);		
	...
	public static ColorFilter adjustColor(int hue) {
		cm.reset();
		adjustHue(cm, hue);
